...
import ScoredCardView from '../ScoreCardView'
...
class MatchGame extends Component {
  ...
  onClickImagePicture = clickedImage => {
    ...
    this.setState({imageUrl: randomImage})

    if (imageUrl === clickedImage) {
  ...
  render() {
    const {isGameInProgress, score, activeTabId, imageUrl, seconds} = this.state
    const filteredImageList = this.getFilteredImagesList()
    ...
    return (
      <div className="app-container">
        <NavBar
          ...
          currentScore={score}
        />
        {seconds === 0 || isGameInProgress === true ? (
          <ScoredCardView
            isWon={isGameInProgress}
          ...
          <>
            <div className="image-list-container">
              <img src={imageUrl} alt="match" className="matching-image" />
              ...
              <ul className="thumbnail-list-container">
                {filteredImageList.map(imageDetails => (
                  <MatchGameItems
                    ...
                    onClickImagePicture={this.onClickImagePicture}
                  />
                ))}
              </ul>
            </div>
